...
Huge sets the radius to 11.
	...
	{ var = "enemyRarity", type = "list", label = "Enemy Rarity:", default = "Normal", tooltip = "Choose the enemy rarity (mainly used for culling strike).\nThe enemy will automatically be considered to be Unique if they are a Boss.",list = {
		{val="Normal",label="Normal"},
		{val="Magic",label="Magic"},
		{val="Rare",label="Rare"},
		{val="Unique",label="Unique"},
	} },
	{ var = "enemyIsBoss", type = "list", label = "Is the enemy a Boss?", defaultIndex = 3, tooltip = data.enemyIsBossTooltip, list = {{val="None",label="No"},{val="Boss",label="Standard Boss"},{val="Pinnacle",label="Guardian/Pinnacle Boss"},{val="Uber",label="Uber Pinnacle Boss"}}, apply = function(val, modList, enemyModList, build)
		...
		elseif val == "Boss" then
			...
			build.configTab.varControls['enemyRarity']:SelByValue("Unique", "val")
